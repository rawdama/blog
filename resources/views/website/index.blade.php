        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 435px;">
                        ...
                        <div class="overlay">
                            <div class="mb-1">
                                <a class="text-white" href="{{Route('category.show',$post->category->id)}}">{{$post->category->title}}</a>
            ...
            <div class="col-lg-4">
                ...
                <div class="position-relative overflow-hidden mb-3" style="height: 80px;">
                    ...
                    <a href="{{Route('category.show',$category->id)}}" class="overlay align-items-center justify-content-center h4 m-0 text-white text-decoration-none">
                       {{$category->title}}
                    </a>
                </div>
                @endforeach
