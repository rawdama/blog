    ...
    <header class="navbar">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav pull-left hidden-md-down">
                <li class="nav-item dropdown">{{ auth()->user()->name }} {{ auth()->user()->status }}</li>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const allEditors = document.querySelectorAll('textarea[id^="editor-"]');
        ...
        allEditors.forEach(editorElement => {
            ClassicEditor
                ...
                .then(editor => {
                    window.editor = editor; // Store each editor instance if needed
                })
                .catch(error => {
                    console.error(error);
                });
