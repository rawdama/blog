                                    ...
                                    @foreach (config('app.languages') as $key => $lang)
                                        <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="{{ $key }}[smallDesc]" class="form-control" id="editor-smallDesc-{{ $key }}" cols="50" rows="10"></textarea>
                                            </div>


                                            <div class="form-group col-md-12">
                                                <label>{{ __('words.content') }}</label>
                                                <textarea name="{{ $key }}[content]" class="form-control" id="editor-content-{{ $key }}" cols="50" rows="10"></textarea>
                                            </div>
